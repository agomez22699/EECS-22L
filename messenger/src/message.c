...
static void create_friend_acceptGUI(void){
	...
	gtk_container_add(GTK_CONTAINER(window7), AcceptGUI);
...
static void create_friend_requestGUI(void){
	//Creating New Window
	...
	gtk_container_add(GTK_CONTAINER(window6), FriendRequestGUI);
...
static void create_block_friendGUI(void){
	//Creating New Window
	...
	gtk_container_add(GTK_CONTAINER(window5), BlockGUI);
...
static void create_delete_friendGUI(void){
	...
	gtk_container_add(GTK_CONTAINER(window4), DeleteGUI);
...
static void createNewUser(void){
	...
	gtk_container_add(GTK_CONTAINER(window3), CreateAccountImage);
...
static void createLogin(void){
	...
	gtk_container_add(GTK_CONTAINER(window2), LoginGUI);
	...
	//Events
	//g_signal_connect(LoginButton, "clicked",(G_CALLBACK(ENTER ADD FRIEND FUNCTION HERE), NULL);
	//g_signal_connect(SignupButton, "clicked",(G_CALLBACK(ENTER SEND MESSAGE FUNCTION HERE), NULL);
...
static void createMess(void){
	...
	gtk_container_add(GTK_CONTAINER(window),MessageImage);
	...
	//Events
	//g_signal_connect(AddFriendButton, "clicked",(G_CALLBACK(ENTER ADD FRIEND FUNCTION HERE), NULL);
	//g_signal_connect(SendMessageButton, "clicked",(G_CALLBACK(ENTER SEND MESSAGE FUNCTION HERE), NULL);
...
int main(int argc, char *argv[]){
	...
	//createLogin();
	//createNewUser();
	//create_delete_friendGUI();
	//create_block_friendGUI();
	//create_friend_requestGUI();
	create_friend_acceptGUI();
